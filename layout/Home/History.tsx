...
export const History = () => (
  <Heading
    ...
    color="textProminent"
  >
    I started my <Note name="career">career</Note> running a screenprinting{' '}
    ...
    <Note name="nyc">NYC</Note>. I worked as a{' '}
    ...
    pixels and moving to <Note name="sf">San Francisco</Note> to become a
    product <Note name="designer">designer</Note>.
    <br />
    <br />
    It wasn&apos;t long before I discovered the magic of programming and started
    learning <Note name="js">JavaScript</Note> while helping launch a browser at{' '}
    <Tip name="brave">Brave</Tip> that was powered by{' '}
    ...
    Science from Stanford. I like <Note name="french">French Bulldogs</Note>,{' '}
    <Note name="cryptocurrency">cryptocurrency</Note>, and my{' '}
    <Tip name="aprilia">Aprilia</Tip> RS 660. If you let me too close to your
    closet I&apos;ll <Note name="organize">organize it</Note>.
  </Heading>
)
