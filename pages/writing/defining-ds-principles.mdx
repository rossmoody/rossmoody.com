...
<Image src={three} alt="Leading by example vs leading by instruction" showAlt />
...
<Image src={four} alt="Component variations">
  These variations produce a button with an icon. What is the best balance
