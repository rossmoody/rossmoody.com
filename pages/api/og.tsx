    ...
    (
      ...
      >
        ...
        >
          ...
          >
            <circle cx="12" cy="12" r="12" fill="#ECAE8B" />
            <path d={MONOGRAM_PATH} fill="#ffffff" />
          </svg>
          <div style={{ fontSize: '88px', fontWeight: 500, letterSpacing: '-0.02em' }}>
            Ross Moody
          </div>
        </div>
        ...
        >
          ...
          >
            Designer, programmer, and design systems thinker that loves making
            things for the web.
          </div>
          <div
            style={{
          ...
          >
            ...
            />
            Currently building Pennyweight
          </div>
        </div>
      </div>
    ),
