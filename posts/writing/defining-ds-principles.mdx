...
lastUpdated: Dec 01 2021 00:00:00 GMT-0700
...
For me, this could be the only principle on this page as it underpins everything else. Design systems are massively subjective, but they have a tendency to position themselves as the "right" or "best" way to do something.

It took me many years to realize, there is no "right" or "best" way. It's always a collection of decisions that are the byproduct of prioritizing certain values over others.
...
Let me phrase this a different way: if the primary goal of your design system is consistency, then fundamentally the first reaction to any change will be "no" on the basis that it's different. That has always felt like an unapproachable and uninspiring way to create.
