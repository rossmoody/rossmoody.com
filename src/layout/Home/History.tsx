...
export const History = () => (
		...
		>
				...
				design systems and writing effective documentation to align design and engineering teams.
				<br/>
				<br/>
				These days I split my time between being a Principal Design Technologist at{' '}
				<Tip name="splunk">Splunk</Tip> and tinkering with app development. I like <Note name="french"
